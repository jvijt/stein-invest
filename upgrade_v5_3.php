...
?><!doctype html><html lang="nl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Upgrade v5.3</title>
...
<?php if($done):?><p class="ok">Upgrade voltooid.</p><p class="small">Verwijder upgrade_v5_3.php nu via FTP.</p><p><a style="color:#78a9ff" href="index.php">Terug naar dashboard</a></p>
<?php else:?><p>V5.3 voegt het volledig verwijderen van een positie per platform toe.</p><?php if($error):?><p class="err"><?=h($error)?></p><?php endif;?>
